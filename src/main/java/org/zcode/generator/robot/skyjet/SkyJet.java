...
public class SkyJet implements IZathuraSkyJetTemplate, IZathuraGenerator {
	...
	public void toGenerate(MetaDataModel metaDataModel, String projectName, String folderProjectPath,Properties propiedades) throws Exception {
		...
		try {
			...
			this.zcodeVersion = propiedades.getProperty("zcodeVersion");
	...
	public void doTemplate(String hdLocation, MetaDataModel metaDataModel, String jpaPckgName, String projectName, String domainName) throws Exception {
		...
		try {
			...
			velocityContext.put("zcodeVersion", zcodeVersion);
	...
	public void doRepository(MetaData metaData, VelocityContext context, String hdLocation) throws Exception {
		try {
			...
			GoogleCodeFormatter.formatJavaCodeFile(path + metaData.getRealClassName() + "Repository.java");
	...
	public void doDto(MetaData metaData, VelocityContext context, String hdLocation, MetaDataModel dataModel,
		...
		try {
			...
			swDto.close();
			fwDto.close();
			GoogleCodeFormatter.formatJavaCodeFile(path + metaData.getRealClassName() + "DTO.java");
	...
	public void doExceptions(VelocityContext context, String hdLocation) throws Exception {
		try {
			...
			GoogleCodeFormatter.formatJavaCodeFile(path + "ZMessManager.java");
			GoogleCodeFormatter.formatJavaCodeFile(path + "VortexbirdException.java");
	...
	public void doPomXml(VelocityContext context, String hdLocation)throws Exception{
		...
		try {
			...
			String description = "Spring Boot Project generated by Zathuracode " + zcodeVersion;
			...
			GoogleCodeFormatter.formatJavaCodeFile(pomLocation);
	...
	public void doEntityGenerator(MetaData metaData, VelocityContext velocityContext, String hdLocation,
		...
		try {
			...
			if (metaData.getComposeKey() != null) {
				...
				GoogleCodeFormatter.formatJavaCodeFile(path + metaData.getRealClassName() + "Id" + ".java");
			}
	...
	public void doSpringBootRunner(VelocityContext context, String hdLocation, MetaDataModel dataModel,
		...
		try {
			...
			GoogleCodeFormatter.formatJavaCodeFile(path + "SpringBootRunner.java");
		} catch (Exception e) {
			log.error(e.toString());
			throw e;
		}
